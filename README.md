...
```javascript
import gwax from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gwax@deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gwax@deno/mod.js';
```
...
[@stdlib/blas/ext/base/gwaxpb]: https://github.com/stdlib-js/blas-ext-base-gwaxpb/tree/deno
